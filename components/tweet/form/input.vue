<template>
  <div>
    ...
    <div class="p-4 pl-16">
      ...
      <input type="file" ref="imageInput" hidden accept=".png, .gif, .jpg, .jpeg" @change="handleImageChange">
    </div>

    <!-- Icons -->
    <div class="flex p-2 pl-14">
        <div class="p-2 text-blue-400 rounded-full hover:bg-blue-100 dark:hover:bg-dim-800 cursor-pointer" @click="handleImageClick">
        ...
        <div class="p-2 text-blue-400 rounded-full hover:bg-blue-100 dark:hover:bg-dim-800 cursor-pointer">
          <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
            <g>
                <path
    ...
    <div>
      <UIButton size="sm">Tweet</UIButton>
